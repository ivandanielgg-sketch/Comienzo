...
/**
 * Browser build of src/serviceQuoterBuildup.js (keep in sync).
 * Exposed as window.ServiceQuoterBuildup.
 */
(function (root, factory) {
  ...
  function computeQuoteTotals({
    ...
    return { labor, subtotal, priceBeforeIva, iva, total };
  }
