...
function ensurePostgresColumns(database) {
  const alters = [
    ...
    'ALTER TABLE manual_payroll_expenses ADD COLUMN IF NOT EXISTS week_number INTEGER',
    'ALTER TABLE manual_payroll_expenses ADD COLUMN IF NOT EXISTS week_start_date TEXT',
    'ALTER TABLE manual_payroll_expenses ADD COLUMN IF NOT EXISTS week_end_date TEXT',
    'ALTER TABLE manual_payroll_expenses ADD COLUMN IF NOT EXISTS payroll_attendance_week_id INTEGER',
    'ALTER TABLE manual_payroll_expenses ADD COLUMN IF NOT EXISTS deleted_at TEXT',
    'ALTER TABLE manual_payroll_expenses ADD COLUMN IF NOT EXISTS deleted_by_user_id INTEGER',
    'ALTER TABLE manual_payroll_expenses ADD COLUMN IF NOT EXISTS deleted_by_name TEXT',
    'ALTER TABLE manual_payroll_expenses ADD COLUMN IF NOT EXISTS delete_reason TEXT',
