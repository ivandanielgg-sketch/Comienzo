...
CREATE TABLE projects (
      ...
      created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
      updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
    , created_by_user_id INTEGER, created_by_name TEXT, updated_by_user_id INTEGER, updated_by_name TEXT, deleted_at TEXT, deleted_by_user_id INTEGER, deleted_by_name TEXT, delete_reason TEXT, credit_days INTEGER, credit_days_na INTEGER NOT NULL DEFAULT 0, invoice_date TEXT, invoice_date_na INTEGER NOT NULL DEFAULT 0, invoice_date_na_reason TEXT, credit_days_na_reason TEXT, due_date TEXT, invoice_number TEXT, invoice_payment_status TEXT, lead_channel TEXT, next_commercial_action TEXT, next_commercial_action_date TEXT, lost_reason TEXT, technical_closed_at TEXT, technical_report_complete INTEGER NOT NULL DEFAULT 0, rework INTEGER NOT NULL DEFAULT 0, rework_cause TEXT, invoice_requested_at TEXT, invoice_issued_at TEXT, invoice_accepted_at TEXT, invoice_paid_at TEXT, invoice_cancelled INTEGER NOT NULL DEFAULT 0, invoice_error INTEGER NOT NULL DEFAULT 0, invoice_pending_docs INTEGER NOT NULL DEFAULT 0,       collection_contact_at TEXT, collection_notes TEXT, fecha_vencimiento TEXT, tecnico_id INTEGER, vendedor_id INTEGER, reports_archived_at TEXT, reports_archived_by_user_id INTEGER, reports_archived_by_name TEXT);
